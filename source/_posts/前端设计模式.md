...
#### UML
![前端设计模式_代理模式UML_2018919161620](http://b.zhangyapeng.club/前端设计模式_代理模式UML_2018919161620.png)
...
![前端设计模式_外观模式_2018919165551]
(http://b.zhangyapeng.club/前端设计模式_外观模式_2018919165551.png)

#### UML类图
![前端设计模式_外观模式UML_2018919165818](http://b.zhangyapeng.club/前端设计模式_外观模式UML_2018919165818.png)

```js
function binfEvent(ele,type,selector,fn){
    if(fn==null){
        fn=selector
        selector=null
    }
...
#### UML类图
![前端设计模式_观察者模式_201892013155](http://b.zhangyapeng.club/前端设计模式_观察者模式_201892013155.png)

```js
//主题保存状态，状态变化之后触发所有观察者对象
class Subject{
    constructor(){
        this.state=0;
        this.observers=[]
